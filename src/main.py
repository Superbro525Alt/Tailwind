...
if __name__ == "__main__":
    ...
    window.add_widget(Button(style=util.Style.empty(), properties={"text": "Test Button"}, binds={}, window=window), {"place": {"relx": 0.5, "rely": 0.5, "anchor": util.NorthWestAnchor().get_anchor()}})
    window.add_widget(Label(style=util.Style.empty(), properties={"text": "Test Label"}, binds={}, window=window), {"place": {"relx": 0, "rely": 0, "anchor": util.WestAnchor.get_anchor()}})
